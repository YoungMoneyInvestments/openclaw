...
export const FIELD_HELP: Record<string, string> = {
  ...
  "talk.voiceAliases":
    'Use this legacy ElevenLabs voice alias map (for example {"OpenClaw":"EXAVITQu4vr4xnSDxMaL"}) only during migration. Prefer talk.providers.elevenlabs.voiceAliases.',
  "talk.modelId":
